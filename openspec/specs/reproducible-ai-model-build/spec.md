# reproducible-ai-model-build Specification

## Purpose

Ensure ordinary AI and workspace builds are reproducible from the committed model catalog while keeping catalog refresh an explicit, reviewable maintainer action.
