...
After PR #62, `docs/review-loop-log.jsonl` contains fourteen merged multi-round PRs with lens attribution. Later-round verified catches remain pinned-core `5`, rotated-in `0`. PR #62 contributed four Round 1 catches and no later-round catch; its Round 2 was clean.
...
- revert follow-up rounds to the round-1 mix, based on the fourteen-PR `core=5 / rotated=0` sample;
